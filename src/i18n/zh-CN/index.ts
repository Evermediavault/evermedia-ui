...
export default {
  ...
  partnerList: {
    ...
    edit: '编辑',
    delete: '删除',
    deleteConfirm: '确定要删除合作伙伴「{name}」吗？',
    formLogo: 'Logo（https）',
    formTag: '标签',
    formName: '名称',
    formDescription: '描述（最多 500 字）',
    formLink: '链接（https）',
    columns: {
      id: 'ID',
      logo: 'Logo',
  ...
  userList: {
    ...
    emailExists: '邮箱已被使用',
    allianceFieldsHint: '以下为联盟成员专属，仅当角色为「联盟成员」时需填写',
    logo: 'Logo',
    logoPlaceholder: '可访问的 https 链接',
    projectName: '项目名称',
    projectNamePlaceholder: '选填',
    intro: '简介',
    introPlaceholder: '选填',
    website: '官网',
    websitePlaceholder: '选填，若填须为 https 链接',
    twitter: '推特',
    twitterPlaceholder: '选填',
  },
