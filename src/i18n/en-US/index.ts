...
export default {
  ...
  contactSubmissions: {
    ...
    tapForDetail: 'Tap for full message',
    detailTitle: 'Message from {name}',
    fields: {
      email: 'Email',
      ip: 'IP',
  ...
  partnerList: {
    ...
    formTag: 'Tag',
    formName: 'Name',
    formDescription: 'Description (max 500 characters)',
    formLink: 'Link (https)',
    columns: {
      id: 'ID',
      logo: 'Logo',
  ...
  userList: {
    ...
    roleAllianceMember: 'Alliance Member',
    roleAdmin: 'Admin',
    ...
    allianceFieldsHint: 'Alliance Member only; required when role is Alliance Member',
    logo: 'Logo',
    logoPlaceholder: 'Accessible https URL',
    projectName: 'Project name',
    projectNamePlaceholder: 'Optional',
    intro: 'Intro',
    introPlaceholder: 'Optional',
    website: 'Website',
    websitePlaceholder: 'Optional; must be https if provided',
    twitter: 'Twitter',
    twitterPlaceholder: 'Optional',
  },
  ...
  upload: {
    ...
    successBatch: 'Successfully uploaded {count} files',
    error: 'Upload failed',
    errorFile: '{name}: {reason}',
    retryHint: 'Check network or try again later.',
    fileName: 'File name',
    fileNamePlaceholder: 'Optional; leave blank to use original filename',
    ...
    addGroup: 'Add metadata group',
    addFile: 'Add file',
    blockLabel: 'File {index}',
    metaGroupDefault: 'Metadata group',
    removeGroup: 'Remove metadata group',
    ...
    selectAllFilesBeforeAdd: 'Please select a file for each existing item before adding another.',
  },

  // File selection
  fileSelection: {
    fileName: 'File name',
    fileNamePlaceholder: 'Optional; leave blank to use selected file name',
    browse: 'Choose file',
